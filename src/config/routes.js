    ...
    return (
        <Switch>
            ...
            <Route path="/event/:event_id" render={(props) => 
                <EventsContainer {...props} handleEventDelete={handleEventDelete} profile={profile} currentUser={currentUser} events={events} displayPosts={displayPosts} {...history} eventID={props.match.params.event_id} goBack={props.goBack} />} />
            <Route path="/update_profile" render={(props) => 
                <ProfileContainer {...props} handleEventDelete={handleEventDelete} profile={profile} currentUser={currentUser} goBack={props.goBack} {...history} events={events} editProfile={true} />} />
